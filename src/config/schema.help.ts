...
export const FIELD_HELP: Record<string, string> = {
  ...
  "plugins.entries.*.hooks.allowConversationAccess":
    "Controls whether this plugin may read raw conversation content from typed hooks such as `llm_input`, `llm_output`, `llm_message_end`, and `agent_end`. Non-bundled plugins must opt in explicitly.",
